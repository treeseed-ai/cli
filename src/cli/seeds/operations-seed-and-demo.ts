...
export const seedAndDemoOperationSpecs: OperationSpec[] = [
	{
			...
			usage: 'treeseed seed <name> [--environments local,staging,prod] [--plan|--validate|--apply] [--json]\n       treeseed seed repositories <name> --environments <environment> [--project <slug>] [--repository-role <role>] [--unit-types <list>] [--plan|--apply --yes] [--json]\n       treeseed seed platform-workspace <name> --branch <branch> --source-ref <sha> [--plan|--apply --yes] [--json]\n       treeseed seed market-api-workspace <name> --branch <branch> --sdk-ref <sha> --admin-api-ref <sha> [--plan|--apply --yes] [--json]\n       treeseed seed support-workflows <name> --project <repository> [--plan|--apply --yes] [--json]\n       treeseed seed licenses <name> --project <slug> [--plan|--apply --yes] [--json]\n       treeseed seed source-repositories <name> --project <slug> [--plan|--apply --yes] [--json]\n       treeseed seed content-repositories <name> [--project <slug>] [--plan|--apply --yes] [--json]\n       treeseed seed export <name> --team <team> [--output <path>] [--json]',
			...
			options: [
				...
				{ name: 'project', flags: '--project <slug>', description: 'Limit content-repository history migration to one project; required for apply.', kind: 'string' },
				{ name: 'branch', flags: '--branch <branch>', description: 'Exact target branch for branch-scoped workspace reconciliation.', kind: 'enum', values: ['main', 'staging'] },
				{ name: 'sourceRef', flags: '--source-ref <sha>', description: 'Exact committed Market source ref for Platform workspace generation.', kind: 'string' },
				{ name: 'sdkRef', flags: '--sdk-ref <sha>', description: 'Exact SDK dependency ref for Market API generation.', kind: 'string' },
				{ name: 'adminApiRef', flags: '--admin-api-ref <sha>', description: 'Exact Admin API dependency ref for Market API generation.', kind: 'string' },
				{ name: 'repositoryRole', flags: '--repository-role <role>', description: 'Limit repository reconciliation to primary, content, or support repositories.', kind: 'string', values: ['primary', 'content', 'support'] },
				{ name: 'unitTypes', flags: '--unit-types <list>', description: 'Comma-separated exact reconciliation unit types for bounded recovery or acceptance.', kind: 'string' },
			...
			examples: [
				...
				'trsd seed repositories treeseed --project admin --environments staging --plan --json',
				'trsd seed platform-workspace treeseed --branch staging --source-ref <market-staging-sha> --plan --json',
				'trsd seed support-workflows treeseed --project fixtures --plan --json',
				'trsd seed licenses treeseed --project api --plan --json',
				'trsd seed source-repositories treeseed --project template-engineering --plan --json',
				'trsd seed content-repositories treeseed --project admin --plan --json',

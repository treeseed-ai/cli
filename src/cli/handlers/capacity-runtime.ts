...
export async function runCapacityLifecycleAction(action: string, invocation: TreeseedParsedInvocation, context: TreeseedCommandContext) {
...
export async function runCapacityProviderEntrypoint(action: string, invocation: TreeseedParsedInvocation, context: TreeseedCommandContext) {
	const market = resolveMarket(invocation);

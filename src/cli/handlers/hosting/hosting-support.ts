...
import type { ReconcileSelector, ReconcileTarget } from '@treeseed/sdk/reconcile';
import { collectConfigSeedValues } from '@treeseed/sdk/workflow-support';
import type { CommandHandler } from '../../types.js';

export function environmentFor(value: unknown): HostingEnvironment {
...
export function targetFor(environment: HostingEnvironment): ReconcileTarget {
...
export function productionImageRefDefaults(root: string, environment: HostingEnvironment) {
...
export function selectedSeedEnv(context: Parameters<CommandHandler>[1], environment: HostingEnvironment) {
	return {

import { runTreeseedLocalCleanup, type TreeseedLocalCleanupMode } from '@treeseed/sdk/workflow-support';
import type { TreeseedCommandHandler } from '../types.js';

function cleanupMode(value: unknown): TreeseedLocalCleanupMode {
...
export const handleCleanup: TreeseedCommandHandler = async (invocation, context) => {

...
import { reconcileTreeseedTarget, type TreeseedReconcileSelector } from '@treeseed/sdk/reconcile';
...
export async function readCapacityWorkdayAgentSpecs(context: TreeseedCommandContext, projectSlug: string): Promise<CapacityWorkdayAgentSpec[]> {
...
export async function ensureLocalTreeDxForCapacityWorkday(context: TreeseedCommandContext, projectSlugs: string[]) {

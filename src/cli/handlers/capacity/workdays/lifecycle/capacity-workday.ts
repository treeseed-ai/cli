...
function executeRequested(invocation: ParsedInvocation) {
	return invocation.args.execute === true;
}

function planRequested(invocation: ParsedInvocation) {
...
export async function runCapacityWorkdayAction(action: string, invocation: ParsedInvocation, context: CommandContext) {

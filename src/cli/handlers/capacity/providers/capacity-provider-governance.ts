...
import { capacityStringArg as argument } from '../capacity-core/capacity-command-arguments.js';
...
function manifestPath(invocation: ParsedInvocation, context: CommandContext) {
...
async function offerDocument(invocation: ParsedInvocation, context: CommandContext) {
...
function providerCoordinatorEnvironment(loaded: Awaited<ReturnType<typeof loadProviderManifest>>, context: CommandContext, additionalProfiles: string[] = []) {
...
export async function runCapacityProviderGovernanceAction(action: string, invocation: ParsedInvocation, context: CommandContext) {

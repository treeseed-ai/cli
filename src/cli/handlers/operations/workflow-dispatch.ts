...
function jsonResult(invocation: ParsedInvocation, context: unknown, report: Record<string, unknown>, exitCode: number) {
...
export const handleWorkflow: CommandHandler = async (invocation, context) => {
	try {

...
export function ok(lines: string[] = []): CommandResult {
	return { exitCode: 0, stdout: lines };
}

export function fail(message: string, exitCode = 1): CommandResult {
...
export function guidedResult(options: GuidedResultOptions): CommandResult {
...
export function writeResult(result: CommandResult, context: CommandContext) {

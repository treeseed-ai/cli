...
export function example(commandLine: string, title: string, description: string, extras: Pick<TreeseedStructuredCommandExample, 'result' | 'why'> = {}): TreeseedStructuredCommandExample {
	return {
		command: commandLine,
		title,
		description,
...
export const DEV_RUNTIME_OPTIONS: TreeseedCommandOptionSpec[] = [
...
export function mergeHelpSpec(metadata: TreeseedOperationMetadata, overlay: CommandOverlay, spec: Omit<TreeseedOperationSpec, 'help'>): TreeseedCommandHelpSpec {
...
export const PASS_THROUGH_ARGS = (invocation: TreeseedParsedInvocation) => ({ args: invocation.rawArgs });

export const TOOL_WRAPPER_OPTIONS: TreeseedCommandOptionSpec[] = [

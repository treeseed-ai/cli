	...
	['config', command({
			...
			help: {
				...
				automationNotes: [
					...
					'`--bootstrap`, `--bootstrap --preflight`, `--print-env-only`, and `--rotate-machine-key` are operational paths that bypass the interactive UI.',

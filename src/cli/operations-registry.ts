...
const CLI_ONLY_OPERATION_SPECS: TreeseedOperationSpec[] = [
	...
	},
	{
		...
		examples: [
			...
			'treeseed capacity migrate --to-derived --market local --team team_123 --provider provider_123 --kind codex_subscription --native-unit wall_minute --limit 480 --scope daily --plan',
		...
		help: {
			...
			automationNotes: ['Use `--json` for stable output. Assignment, mode-run, and assignment-explanation inspection includes read-only execution visibility and capability match summaries. Use `--plan` for lifecycle previews and `--execute` for mutations.'],
		},
		helpVisible: true,
		helpFeatured: false,
		executionMode: 'handler',

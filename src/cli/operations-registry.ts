...
const CLI_COMMAND_OVERLAYS = new Map<string, CommandOverlay>([
	...
	['save', command({
		...
		options: [
			...
			{ name: 'workspaceLinks', flags: '--workspace-links <mode>', description: 'Control local workspace package links.', kind: 'enum', values: ['auto', 'off'] },
			{ name: 'skipCleanup', flags: '--skip-cleanup', description: 'Skip the automatic local cache, npm, Docker, and generated-evidence cleanup before long verification.', kind: 'boolean' },
			{ name: 'sceneArtifacts', flags: '--scene-artifacts <mode>', description: 'Choose scene evidence mode for downstream checks.', kind: 'enum', values: ['full', 'screenshots'] },

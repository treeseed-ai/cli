...
const CLI_ONLY_OPERATION_SPECS: TreeseedOperationSpec[] = [
	...
	},
	{
		...
		description: 'Read Market capacity plans, migrate static providers to derived native capacity, and operate provider lifecycle resources through canonical reconciliation.',
		provider: 'default',
		...
		help: {
			longSummary: ['Capacity reads Market project capacity plans, migrates provider setup toward derived native facts, and routes package-owned provider lifecycle resources through canonical reconciliation.'],
			...
			automationNotes: ['Use `--json` for stable output. Lifecycle actions are dry-run unless `--execute` is supplied.'],
		},
		helpVisible: true,
		helpFeatured: false,
		executionMode: 'handler',

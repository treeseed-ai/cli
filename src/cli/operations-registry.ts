...
const CLI_ONLY_OPERATION_SPECS: TreeseedOperationSpec[] = [
	...
	},
	{
		...
		usage: 'treeseed capacity [doctor|register|plan|migrate|allocation-sets|agent-classes|provider-sessions|assignments|mode-runs|decision-planning|execution-inputs|capacity-plans|capacity-plan|workday|workday-summary|assignment-explanation|up|down|restart|logs|status|build|test-local]',

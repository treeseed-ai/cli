...
test('package has one executable and only its declared CLI runtime dependencies', () => {
	...
	assert.deepEqual(pkg.dependencies, { '@treeseed/sdk': 'github:treeseed-ai/sdk#400d936a531a234379c7bb2bc64cdf716bff1504', ink: '^7.1.1', react: '^19.2.8', 'string-width': '^8.2.2', yaml: '2.9.0' });
});

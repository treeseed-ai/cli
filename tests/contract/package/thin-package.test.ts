...
test('package has one executable and only its declared CLI runtime dependencies', () => {
	...
	assert.deepEqual(pkg.dependencies, { '@treeseed/sdk': 'github:treeseed-ai/sdk#e56e01d0fa50ec3a2f19bdff71e7cffaa94dc030', ink: '^7.1.1', react: '^19.2.8', 'string-width': '^8.2.2', yaml: '2.9.0' });
});

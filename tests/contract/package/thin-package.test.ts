...
test('package has one executable and only its declared CLI runtime dependencies', () => {
	...
	assert.deepEqual(pkg.dependencies, { '@treeseed/sdk': 'github:treeseed-ai/sdk#4936ec8652929683c5ad6d6fd5f7973cfa67299d', ink: '^7.1.1', react: '^19.2.8', 'string-width': '^8.2.2', yaml: '2.9.0' });
});
